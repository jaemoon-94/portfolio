...
<header>
    <div class="container">
        <nav class="navbar">
            <a href="${pageContext.request.contextPath}/main/main.do" class="logo">CozyTrip</a>
            <form id="searchForm" action="${pageContext.request.contextPath}/accom/accomList.do" method="get">
                <div class="nav-search">
                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
                         style="display:block;fill:none;height:16px;width:16px;stroke:#717171;stroke-width:4;overflow:visible"
                         aria-hidden="true" role="presentation" focusable="false">
                        <circle cx="13" cy="13" r="8"></circle>
                        <line x1="21" y1="21" x2="26" y2="26"></line>
                    </svg>
                    <input type="text" name="keyword" placeholder="어디로 여행가세요?" />
                    <input type="hidden" name="keyfield" value="address1" />
                </div>
            </form>
            <div class="nav-links">
                <c:if test="${!empty user_num}">
                    <a href="${pageContext.request.contextPath}/host/registerAccomForm.do" class="host-btn">숙소 추가하기</a>
                    <div class="host-profile" id="hostProfile">
                        ...
                        <div class="dropdown-menu" id="dropdownMenu">
                            ...
                            <a href="${pageContext.request.contextPath}/host/accomList.do">호스트 모드 전환</a>
