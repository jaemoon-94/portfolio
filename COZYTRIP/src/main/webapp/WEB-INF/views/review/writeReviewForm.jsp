...
<body>
	...
	<section class="review-container">
		...
		<div class="review-form-wrap">
			...
			<!-- 오른쪽 리뷰 작성 폼 -->
			<form action="writeReview.do" method="post" class="review-form">
			<input type="hidden" name="reserv_num" value="${param.reserv_num}">
				<div class="rating-group">
					<div>
						<label>숙소 평가</label>
						<div class="star-rating">
							<input type="radio" name="rating" value="5" id="accom5"><label
								for="accom5">★</label> <input type="radio" name="rating"
								value="4" id="accom4"><label for="accom4">★</label> <input
								type="radio" name="rating" value="3" id="accom3"><label
								for="accom3">★</label> <input type="radio" name="rating"
								value="2" id="accom2"><label for="accom2">★</label> <input
								type="radio" name="rating" value="1" id="accom1"><label
								for="accom1">★</label>
						</div>
					</div>
				</div>
