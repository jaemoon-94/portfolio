...
<div class="container">
    ...
    <div class="tabs">
        <a href="inquiryWaiting.do" class="tab active">답변 대기</a>
        <a href="inquiryCompleted.do" class="tab">답변 완료</a>
    </div>
    <form action="inquiryWaiting.do" method="get" class="search-form">
    ...
    <c:forEach var="inqList" items="${inqList}">
        <div class="inquiry" data-inq-num="${inqList.inquiry_num}" data-accom-num="${inqList.accom_num}">
            ...
            <form action="${pageContext.request.contextPath}/host/inquiryAnswer.do" method="post" class="answer-box">
                <input type="hidden" name="inquiry_num" value="${inqList.inquiry_num}">
                <textarea placeholder="답변을 입력하세요" name="answer_content" required></textarea><br>
