...
public class HostInquiryWaitingAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int count = dao.getInqCount(host_num, "0", accom);
		String addKey = "";
        ...
        if (count > 0) {
        	inqList = dao.getInqList(host_num,"0", accom, page.getStartRow(), page.getEndRow());
        }
		...
		return "host/hostInquiryWaiting.jsp";
	}
